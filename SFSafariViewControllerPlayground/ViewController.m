...
- (IBAction)navigateToDNSFailure:(id)sender {
    ...
    [self loadSafariViewControllerWithURL:[NSURL URLWithString:kDNSFailureURL]];
}
...
- (IBAction)navigateToSyntheticResponse:(id)sender {
    ...
    [self loadSafariViewControllerWithURL:[NSURL URLWithString:url]];
}

- (void)loadSafariViewControllerWithURL:(NSURL*)url {
